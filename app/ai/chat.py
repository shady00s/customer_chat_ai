...
from ai_commands.service_messages.check_for_available import check_for_available_products_service
aiRouter = APIRouter()
from ai_commands.system_messages.message import systemMessage
@aiRouter.post("/chat")
async def chat(text: str):
    # get products before calling ai
    apiResponse = requests.post(AppConstants.aiChatUrl, json={
    ...
    return {"message": "success", "data": evall(apiResponse.json()['message']['content']) }